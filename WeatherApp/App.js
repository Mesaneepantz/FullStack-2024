...
app.get("/weather", async (req,res) => { 
    ...
    const url = "https://api.openweathermap.org/data/2.5/weather?q=ปทุมธานี&appid=1e9337b3055fef44005cc4d61842ed62&units=metric&lang=th"
...
app.post("/anyWeather", async (req,res) => {
    ...
    const province = response.data["name"] //ชื่อจังหวัด
    const temp = response.data["main"]["temp"] //อุณหภูมิ
